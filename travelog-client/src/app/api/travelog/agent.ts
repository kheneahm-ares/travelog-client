...
const TravelPlanService = {
    ...
    removeTraveler: (username: string, travelPlanId: string): Promise<number> =>
        requests.post(`/TravelPlan/RemoveTraveler?travelerUsername=${username}&travelPlanId=${travelPlanId}`, {}),
